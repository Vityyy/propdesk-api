Feature: Administrar apartamentos
  ...
  Scenario: Agregar un apartamento con éxito
    ...
    When intento agregar un apartamento con nombre "A1" y monto 100 para la propiedad "Prop1" y propietario "owner1"
    Then obtengo una respuesta con 1 apartamento creado
    And el apartamento tiene nombre "A1"
  ...
  Scenario: Agregar apartamento a propiedad que no pertenece al propietario falla
    ...
    When intento agregar un apartamento con nombre "A2" y monto 200 para la propiedad "PropOther" y propietario "owner1"
